...
public class CommentServiceImpl implements CommentService {
    ...
    @Override
    public int noReadCommentNums() {
        int noReadNums = blogCommentMapper.findNoReadNums();
        return noReadNums;
    }
}
